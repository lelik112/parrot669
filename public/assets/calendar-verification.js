    ...
    function render(){
      ...
      if(value){
        if(state==="verified"){
          ...
          description=value.baselineReady?(value.expectedAction==="close"?ch.close:ch.open):tr.preparing;
