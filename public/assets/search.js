...
const housingCopy = {
  ...
  es:{accommodationType:"Tipo de alojamiento",anyType:"Cualquier tipo",entirePlace:"Alojamiento entero",privateRoom:"Habitación privada",noExternalLink:"No hay enlace externo disponible",lead:"Encuentra un alojamiento disponible para tus fechas.",searchChanged:"Has cambiado los datos de búsqueda. Vuelve a buscar para ver los alojamientos disponibles."},
  ca:{accommodationType:"Tipus d'allotjament",anyType:"Qualsevol tipus",entirePlace:"Allotjament sencer",privateRoom:"Habitació privada",noExternalLink:"No hi ha cap enllaç extern disponible",lead:"Troba un allotjament disponible per a les teves dates.",searchChanged:"Has canviat les dades de cerca. Torna a cercar per veure els allotjaments disponibles."},
  ru:{accommodationType:"Тип жилья",anyType:"Любой тип",entirePlace:"Жильё целиком",privateRoom:"Отдельная комната",noExternalLink:"Переход на внешнюю площадку недоступен",lead:"Найдите жильё, свободное на ваши даты.",searchChanged:"Параметры изменены. Нажмите «Найти свободное», чтобы увидеть подходящие варианты."}
};
...
const budgetCopy={
  en:{priceFrom:"Stay total from, €",priceTo:"Stay total to, €",priceNegative:"Price cannot be negative.",priceInvalid:"Enter a valid price with up to two decimal places."},
  es:{priceFrom:"Total de la estancia desde, €",priceTo:"Total de la estancia hasta, €",priceNegative:"El precio no puede ser negativo.",priceInvalid:"Introduce un precio válido con un máximo de dos decimales."},
  ca:{priceFrom:"Total de l’estada des de, €",priceTo:"Total de l’estada fins a, €",priceNegative:"El preu no pot ser negatiu.",priceInvalid:"Introdueix un preu vàlid amb un màxim de dos decimals."},
  ru:{priceFrom:"За весь период от, €",priceTo:"За весь период до, €",priceNegative:"Цена не может быть отрицательной.",priceInvalid:"Введите корректную цену: не более двух знаков после запятой."}
};
