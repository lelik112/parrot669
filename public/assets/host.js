...
const copy = {
  en: {
    ...
    accountTitle:"Host account", accountHelp:"Sign in with email and password. Your session is kept in a secure HttpOnly cookie.", loginTitle:"Log in", signupTitle:"Create account", emailLabel:"Email", passwordLabel:"Password", loginButton:"Log in →", signupButton:"Create account →", logoutButton:"Log out", signedInAs:"Signed in as", recoveryNote:"Password recovery is not available yet.", loggingIn:"Logging in…", signingUp:"Creating account…", loggedOut:"Logged out.", legacyMigrated:"Your existing host profile was connected to this account.", legacyMigrationFailed:"Signed in, but the existing browser profile could not be connected. Its old credentials were kept for retry.", legacyDetected:"An existing host profile was found in this browser. Sign in or create an account to connect it.",
...
async function boot(){
  try {
    ...
    else if (legacyState) message(tr("legacyDetected"));
  }
}
