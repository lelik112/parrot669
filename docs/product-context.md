...
- Fix the P2 waiting-state instruction [PM-013](tasks/PM-013-calendar-waiting-instruction.md) and complete remaining independent QA of the saved-date calendar challenge ([PM-001](tasks/PM-001-calendar-control-dates.md)); resolve the separate publication policy before implementing [PM-002](tasks/PM-002-link-publication.md).
