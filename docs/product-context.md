...
- Independently retest the released P2 waiting-state instruction fix [PM-013](tasks/PM-013-calendar-waiting-instruction.md) and complete remaining QA of the saved-date calendar challenge ([PM-001](tasks/PM-001-calendar-control-dates.md)); resolve the separate publication policy before implementing [PM-002](tasks/PM-002-link-publication.md).
...
- The isolated auth route extraction [PM-010](tasks/PM-010-auth-routes-extraction.md) is released and awaits independent QA. Igor has claimed the separate external calendar lifecycle [PM-011](tasks/PM-011-calendar-sync-extraction.md); legacy challenges [PM-012](tasks/PM-012-legacy-challenges-extraction.md) remain LATER. Original sequence is in [D006](decisions/D006-backend-refactor-backlog.md); activation and boundaries are in [D007](decisions/D007-activate-auth-routes-extraction.md).
