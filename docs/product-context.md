...
- At the owner's request, the isolated auth route extraction [PM-010](tasks/PM-010-auth-routes-extraction.md) is NOW and assigned to Igor pending his own claim; it changes no auth behavior and can proceed alongside PM-001's independent QA. External calendar lifecycle [PM-011](tasks/PM-011-calendar-sync-extraction.md) and legacy challenges [PM-012](tasks/PM-012-legacy-challenges-extraction.md) remain LATER. Original sequence is in [D006](decisions/D006-backend-refactor-backlog.md); activation and boundaries are in [D007](decisions/D007-activate-auth-routes-extraction.md).
