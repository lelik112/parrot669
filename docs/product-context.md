...
- [Regression QA two-account procedure](qa/pm036-testers.md): use after the two dedicated Workers and QA account IDs have been activated and live-checked. Both Workers are deployed and their `QA_WORKER_SECRET` bindings pass anonymous live probes; exact account access and A↔B QA remain open.
