...
| F29 | Публичный профиль | Показывать только разрешённые сведения и проверяемые сигналы | idea | later | [PM-022](tasks/PM-022-public-host-profile.md), зависит от PM-002/020 |
