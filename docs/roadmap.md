...
- [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) P2 — done: Игорь/Денис завершили отдельные read-only аудиты, Марк свёл их. Узкие следующие задачи: [PM-037](tasks/PM-037-search-date-range-bound.md) P2/NEXT (предел публичного запроса ещё не согласован) и PM-038 P2/NOW (сохранение host черновиков после QA). Скорость поискового enrichment и FE-3 5xx empty state остаются гипотезами для проверки, без dev claim или большого rewrite.
