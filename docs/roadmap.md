...
| --- | --- | --- |
| [PM-004 — Выбор улицы](tasks/PM-004-street-autofill.md) | P2 | Первый вариант не скрывается браузерной подсказкой |
| [PM-005 — Закрытые даты](tasks/PM-005-closed-dates-copy.md) | P2 | Обычная форма не выглядит недоступной функцией |
...
| F14 | Понятные закрытые даты | Ясный заголовок и обычное оформление формы | planned | P2 | [PM-005](tasks/PM-005-closed-dates-copy.md) |
| F15 | Подсказки улиц | Устранить перекрытие браузерным autofill | planned | P2 | [PM-004](tasks/PM-004-street-autofill.md) |
