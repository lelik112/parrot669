...
| [PM-002 — Внешняя ссылка и verification status](tasks/PM-002-link-publication.md) | P1 | Ссылка доступна независимо от verification; честный status + nudge | D009 accepted; planned, исполнитель не заявлен |
...
| [PM-019 — Контракт кабинета](tasks/PM-019-host-cabinet-ia.md) | P2 | in review: предложена минимальная IA D009; ждёт подтверждения Алексея |
| [PM-020 — Навигация кабинета](tasks/PM-020-host-cabinet-navigation.md) | P2 | После подтверждения D009 связать действующие функции, без пустых разделов; исполнитель не назначен |
...
- [PM-021 — личный профиль](tasks/PM-021-private-host-profile.md) и [PM-022 — публичный профиль](tasks/PM-022-public-host-profile.md) остаются LATER до фактов пилота, таблицы видимости/согласия и решения PM-002 о внешней ссылке. Наличие ограниченного backend public-profile JSON не означает принятия новой публичной страницы.
...
| F13 | Внешняя ссылка + verification status | Не блокировать валидный URL из-за verification; показывать status и nudge | planned | P1 | [PM-002](tasks/PM-002-link-publication.md); [D009](decisions/D009-external-link-independent-verification.md) accepted |
...
| F28 | Личный профиль | Управлять данными хозяина отдельно от учётной записи | idea | later | [PM-021](tasks/PM-021-private-host-profile.md), новые поля не приняты |
| F29 | Публичный профиль | Показывать только разрешённые сведения и проверяемые сигналы | idea | later | [PM-022](tasks/PM-022-public-host-profile.md), зависит от PM-002/021 |
