...
- [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) P2 — только диагностика техдолга и препятствий следующей разработке, planned; предполагаемые Игорь/Денис не claim-или, запуск после первой волны QA отдельно согласовать.
