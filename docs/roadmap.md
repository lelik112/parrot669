...
| --- | --- | --- | --- |
| [PM-001 — Проверка сохранённых дат](tasks/PM-001-calendar-control-dates.md) | P1 | Проверяется конкретное задание пользователя | Назначен Денис; claim ожидается. Старт: контракт/frontend; backend после сверки с рефакторщиком |
...
| [PM-004 — Выбор улицы](tasks/PM-004-street-autofill.md) | P2 | Первый вариант не скрывается браузерной подсказкой | in review; выпущено Денисом, нужен независимый нативный ретест |
| [PM-005 — Закрытые даты](tasks/PM-005-closed-dates-copy.md) | P2 | Обычная форма не выглядит недоступной функцией | in review; выпущено Денисом, нужен независимый визуальный ретест |
...
| F12 | Проверка выбранных дат | Выбор в PARROT, сохранение, внешнее действие, сравнение | planned | P1 | [PM-001](tasks/PM-001-calendar-control-dates.md); назначен Денис, claim ожидается |
