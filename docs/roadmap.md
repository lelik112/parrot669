...
| [PM-011 — Выделение calendar lifecycle](tasks/PM-011-calendar-sync-extraction.md) | P2 | Сгруппировать connect/sync/enable/disable/delete без изменения поведения | Назначено Игорю по поручению владельца; claim и границы ожидаются |
