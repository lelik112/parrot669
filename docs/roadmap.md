...
- [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) P2 — in progress: Марк сделал обзорный аудит двух репозиториев и подготовил ограниченные handoff Игорю (backend) и Денису (frontend); их технические проверки пока без claim и не вытесняют P1 QA. Выводы о задержке поиска, рисках состояния и масштабе работ предварительны; кодовый рефакторинг не запущен.
