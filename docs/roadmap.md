...
[PM-042](tasks/PM-042-agent-check-in-process-audit.md) закрыта как PM-аудит предложения Алекса после исправления коллизии ID с двухаккаунтной PM-036. [PM-043](tasks/PM-043-agent-wake-up-feasibility.md) — техническая проверка на одном агенте без dev claim (рекомендация Sol / High). Здесь есть встроенный планировщик, но его расписание не чаще часа, а GitHub-триггер не реагирует на изменение карточки. Желание проверять назначения каждые пять минут требует другой подтверждённой среды; приоритет P2, не отвлекать команду от QA основного пути.
