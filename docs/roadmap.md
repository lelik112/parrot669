...
| P2 | [PM-005](tasks/PM-005-closed-dates-copy.md), [PM-010](tasks/PM-010-auth-routes-extraction.md), [PM-011](tasks/PM-011-calendar-sync-extraction.md), [PM-013](tasks/PM-013-calendar-waiting-instruction.md), [PM-020](tasks/PM-020-host-cabinet-navigation.md), [PM-021](tasks/PM-021-private-host-profile.md), [BUG-019](tasks/BUG-019-search-account-context.md) | In review, есть доступные desktop/двухаккаунтные проверки; mobile части не объявлять пройденными. PM-020 содержит подтверждённый BUG-022 после PR #23 |

| P1 | [PM-039](tasks/PM-039-browser-test-environments.md) | Марк claim-ил недорогую QA-среду; варианты и актуальные цены записаны; реальный iPhone Safari и доступ Бориса ещё проверить, Sol / Medium |
| P1 | [PM-015](tasks/PM-015-qa-mobile-device-environment.md), [PM-025](tasks/PM-025-search-contact-button-layout.md) | blocked: без автономного iPhone Safari для Бориса; desktop PM-025 partial PASS сохраняется |
...
До первой QA-волны свободной мощности Дениса не назначаем крупную новую фичу; если Борис подтверждает дефект, предложить узкий fix с отдельным claim. PM-017 (почта) и PM-018 (контролируемый Airbnb) — отдельные ресурсы QA; [D015](decisions/D015-qa-environment-blocked-status.md) задаёт честное разделение blocked и in review.
...
- [PM-006](tasks/PM-006-email-acceptance.md) P1 — независимый цикл email после PM-017. [PM-007](tasks/PM-007-mobile-acceptance.md) P1 — blocked, пока Борис не получает управляемый iPhone Safari по PM-015/039; полного QA claim нет.
...
- [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) P2 — done: Игорь/Денис завершили отдельные read-only аудиты, Марк свёл их. Узкие следующие задачи: [PM-037](tasks/PM-037-search-date-range-bound.md) P2/NEXT (контракт 366 ночей принят в D014; замер/реализация/QA открыты, Игорь без claim) и PM-038 P2/NOW (сохранение host черновиков после QA). Скорость поискового enrichment и FE-3 5xx empty state остаются гипотезами для проверки, без dev claim или большого rewrite.
