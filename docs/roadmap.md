...
| --- | --- | --- | --- |
| [PM-001 — Проверка сохранённых дат](tasks/PM-001-calendar-control-dates.md) | P1 | Проверяется конкретное задание пользователя | in review: Борис подтвердил часть desktop A/B и `close`; правка P2 инструкции опубликована, её ретест и `open`/mobile/источник ещё открыты |
...
| [PM-011 — Выделение calendar lifecycle](tasks/PM-011-calendar-sync-extraction.md) | P2 | Сгруппировать connect/sync/enable/disable/delete без изменения поведения | Игорь оставил claim и Model check, этап in progress |
