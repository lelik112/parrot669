...
| --- | --- | --- | --- |
| [PM-001 — Проверка сохранённых дат](tasks/PM-001-calendar-control-dates.md) | P1 | Проверяется конкретное задание пользователя | Требование принято; исполнитель ещё не заявил о начале |
...
| [PM-004 — Выбор улицы](tasks/PM-004-street-autofill.md) | P2 | Первый вариант не скрывается браузерной подсказкой | Денис / Developer, in progress; только frontend |
| [PM-005 — Закрытые даты](tasks/PM-005-closed-dates-copy.md) | P2 | Обычная форма не выглядит недоступной функцией | Денис / Developer, in progress; только frontend |
...
PM-004/005 взяты Денисом по поручению владельца, [claim `d8dc6db`](https://github.com/lelik112/parrot669/commit/d8dc6db7a1381e9bb44b1441207deede4366c2b3), 2026-09-24 07:42 UTC. Он ограничил работу frontend из-за параллельного backend-рефакторинга. Это отражение начатой работы, без изменения приоритета P1 остальных задач.
...
- Дальнейший рефакторинг auth/calendar — с проверкой пересечений с PM-001. Уже выпущенные этапы не планировать повторно.
...
| F11 | Изменение календаря v1 | Обнаруживает любое изменение, без сохранённого задания | done | P1 | Не соответствует целевому требованию; [D002](decisions/D002-calendar-control-dates.md) |
| F12 | Проверка выбранных дат | Выбор в PARROT, сохранение, внешнее действие, сравнение | planned | P1 | [PM-001](tasks/PM-001-calendar-control-dates.md) |
...
| F14 | Понятные закрытые даты | Ясный заголовок и обычное оформление формы | in progress | P2 | [PM-005](tasks/PM-005-closed-dates-copy.md), Денис |
| F15 | Подсказки улиц | Устранить перекрытие браузерным autofill | in progress | P2 | [PM-004](tasks/PM-004-street-autofill.md), Денис |
