...
2. Добавить `QA_WORKER_SECRET` в оба выпущенных Worker origin и настроить точный доступ аккаунтов Никиты; затем Никита проходит [PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md): QA claim, A→B→A, refresh/logout без секретов в отчёте.
