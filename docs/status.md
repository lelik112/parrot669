...
- **20 задач `in review`** по текущему индексу после [D015](decisions/D015-qa-environment-blocked-status.md); PM-015/007/025, BUG-018 и PM-004/014 вынесены в blocked по недоступной среде. В `in review` остаются P1 поиск/контакт и P2 кабинет, сообщения, календарь с исполнимыми desktop/двухаккаунтными или отдельными внешними шагами; частичные PASS не равны done. [PM-030](tasks/PM-030-qa-drain-next-stage.md) сохраняет прежние исторические срезы и новую классификацию.
...
5. Борис идёт по доступной [QA-очереди PM-030](tasks/PM-030-qa-drain-next-stage.md): сначала PM-024/003, затем PM-023/002/001 и desktop P2. PM-025, BUG-018, PM-007/015 и PM-004/014 не помещать в исполнимую очередь до соответствующей среды; смешанные PM-023/026 и BUG-020 сохраняют доступную desktop QA.
