...
- [D011](decisions/D011-contact-always-available.md): каждый объект, оставленный в поиске, имеет PARROT contact path; host-wide opt-in не блокирует первое обращение. Реализация ожидает PM-024.
...
7. PM-025: исправить mobile расположение кнопки после воспроизведения скриншота; PM-026: оставить глобальную Messages-ссылку и убрать дубль из Host shortcuts.
8. PM-027/028: дать хозяину открыть связанное жильё и свой профиль из Messages после текущих PM-020/021 работ.
