...
- **[PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md) / P1 NEXT:** отдельная постановка для двух сессий нового Regression QA; статус planned. Имя QA, его browser access и собственная тестовая пара неизвестны. Игорь указан как developer candidate без claim; сначала проверить вариант двух управляемых browser contexts, расширение PM-029 allowlist — только при необходимости и после решения о точных IDs.
...
2. Подготовить [PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md): проверить собственные два браузерных контекста нового QA и отдельную тестовую пару без пересечения с Борисом. При одном контексте отдельно согласовать минимальное расширение PM-029 guard и negative checks; dev claim после выбора подхода.
