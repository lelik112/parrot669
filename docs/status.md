...
- **Денис — PM-025 / P1:** in progress; claim и Model check Sol / Medium записаны. Web-воспроизведение и отдельная проверка mobile — в работе.
- **Игорь — PM-023 / P1:** назначен Алексеем; в main пока нет claim/Model check, поэтому старт реализации ещё не подтверждён.
- **Следом:** PM-027, затем PM-028. Обе задачи идут по Messages UI и не должны стартовать параллельно PM-023; перед началом сверить файлы и завершение PM-020/021 QA.
- PM-025 и PM-023 — разные поверхности (карточка поиска / подготовка сообщения), конфликтующие активные claims в main не обнаружены.
...
9. PM-027/028: дать хозяину открыть связанное жильё и свой профиль из Messages после текущих PM-020/021 работ.
