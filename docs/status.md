...
2. Настроить точный доступ аккаунтов Никиты к двум QA Worker origin с уже проверенными `QA_WORKER_SECRET`; затем Никита проходит [PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md): QA claim, A→B→A, refresh/logout без секретов в отчёте.
