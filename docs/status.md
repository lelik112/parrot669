...
Дата среза: **2026-09-24**. Автор: **Марк / PM**. Дополнение PM-024 от **2026-09-25**: **Игорь / Developer** (релиз и проверка live UI; независимая QA ещё открыта).
...
8. PM-025: воспроизвести web-сдвиг кнопки и отдельно проверить mobile (владельцем не проверен); PM-026: frontend-изменение Дениса готово и ждёт независимый QA, глобальная Messages-ссылка остаётся.
