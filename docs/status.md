...
- **[PM-043](tasks/PM-043-agent-wake-up-feasibility.md) / P2 NEXT, assigned:** Алексей назначил Игоря / Developer (Sol / High) на техническую проверку запуска конкретного агента; claim ещё нет. После текущей PM-037 Игорь сверяет доступные средства и записывает узкий scope. Пятиминутный check-in/направление в чужие существующие чаты не заявлены работающими.
