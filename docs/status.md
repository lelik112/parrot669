...
8. PM-025: исправить mobile расположение кнопки после воспроизведения скриншота; PM-026: оставить глобальную Messages-ссылку и убрать дубль из Host shortcuts.
