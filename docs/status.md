...
6. [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) закрыта как аудит. Никита — кандидат на QA узкого сценария [PM-038](tasks/PM-038-host-unsaved-drafts-rerender.md) без зависимости от PM-036; после подтверждения и отдельного claim Денис может взять исправление; для [PM-037](tasks/PM-037-search-date-range-bound.md) сначала определить предел одной поисковой заявки по сценарию и замерам. Не запускать большой refactor.
