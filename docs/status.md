...
2. Игорю выпустить и защитить два новых Worker origin, настроить точный доступ аккаунтов Никиты; затем Никита проходит [PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md): QA claim, A→B→A, refresh/logout без секретов в отчёте.
