...
- [D008](decisions/D008-cabinet-sequencing.md): принят только порядок подготовки кабинета; публичные поля/ссылки не утверждены. PM-019/020 — NEXT, PM-021/022 — LATER.
