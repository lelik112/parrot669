...
- **[PM-037](tasks/PM-037-search-date-range-bound.md), P2 NEXT, in progress:** Марк принял [D014](decisions/D014-public-search-date-range.md): максимум 366 ночей на один запрос, отказ на 367+ до SQL, без подмены дат. Игорь принял разработку: код API/UI подготовлен, CI и изолированный замер идут; QA открыта. При плохом замере верхнюю границу пересмотреть до релиза.
