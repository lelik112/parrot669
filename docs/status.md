...
- **21 задача `in review`** (20 из предыдущего среза плюс PM-029), в том числе P1 PM-001/002/023/024/025 и P2 кабинет, сообщения, календарный и мобильный регресс. По каждой — конкретное оставшееся действие в PM-030. Не переводить в done по merge/CI.
