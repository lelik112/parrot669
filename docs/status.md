...
- **[PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md) / P1, in review:** Никита независимо прошёл A→B→A, refresh, logout/relogin обоих аккаунтов `qa2`/`qa3` на выделенных Worker origin. Функциональный доступ доступен для назначенного ручного регресса. Борис / QA Lead подтвердил сохранность собственной пары. Игорь / Developer (Sol / High) собрал CI и частичные live negative evidence; остаётся безопасная live проверка отказа постороннему подтверждённому аккаунту и решение Марка / PM о закрытии.
...
- **[PM-043](tasks/PM-043-agent-wake-up-feasibility.md) / P2 NEXT, planned:** нужен узкий технический spike на одном агенте: проверить автономный запуск нужной сессии, безопасный claim, реальную стоимость и возможность пяти минут/события. Разработчик не назначен: Денис занят PM-040, Игорь — PM-037 и остатком PM-036; никто не claim-ил. Рекомендация Sol / High.
...
3. [PM-036](tasks/PM-036-regression-qa-independent-two-accounts.md): Никитин функциональный A↔B PASS. Борис / Sol / Medium подтвердил свою пару; Игорь / Sol / High проверяет безопасный outsider login negative на новом origin либо фиксирует блокер; Марк решает закрытие после evidence.
...
7. [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) закрыта как аудит. Никита — кандидат на QA узкого сценария [PM-038](tasks/PM-038-host-unsaved-drafts-rerender.md) без зависимости от PM-036; после подтверждения и отдельного claim Денис может взять исправление; для [PM-037](tasks/PM-037-search-date-range-bound.md) Игорь claim-ил реализацию, а Марк принял изолированный performance gate; следующий шаг — Игорю устранить препятствие слияния frontend PR #52, проверить актуальный CI, выпустить backend → frontend и передать Борису QA. Не запускать большой refactor.
