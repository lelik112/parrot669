...
- **[PM-037](tasks/PM-037-search-date-range-bound.md), P2 NEXT:** Игорь подтвердил неограниченный диапазон публичного поиска; верхняя граница одного запроса и нагрузка не измерены. Марк уточняет продуктовый предел до dev claim; Игорь — кандидат Sol/High. Общий rewrite не планируется.
...
6. [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md) закрыта как аудит. Никита проверяет узкий сценарий [PM-038](tasks/PM-038-host-unsaved-drafts-rerender.md) без PM-036, затем Денис может взять исправление после claim; для [PM-037](tasks/PM-037-search-date-range-bound.md) сначала определить предел одной поисковой заявки по сценарию и замерам. Не запускать большой refactor.
