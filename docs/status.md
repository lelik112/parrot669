...
5. Довести QA PM-020; затем брать PM-021 как следующий этап кабинета. PM-022 — после PM-021 с отдельным privacy/publication contract. Пилот не блокирует PM-021.
6. Выполнить PM-023 после PM-024: дать гостю составить обращение до auth и восстановить черновик после входа/регистрации.
