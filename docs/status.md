...
- **Scope:** Продуктовый статус после релизов PM-001.
- **Change:** Зафиксированы выпуск PM-001 в backend/frontend, подтверждённая Денисом публикация frontend и передача на независимую QA-приёмку.
