...
4. После текущих P1 проверок Игорю и Денису отдельно claim-ить read-only [PM-034](tasks/PM-034-backend-frontend-refactoring-audit.md), проверить гипотезы и передать отчёты Марку; рефакторинг кодом не запускать.
