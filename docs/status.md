...
6. Выполнить PM-023: дать гостю составить обращение из поиска до входа, затем требовать auth перед отправкой и восстановить черновик. Задача planned после активной работы PM-020/021.
