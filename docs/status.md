...
4. После текущих P1 проверок Игорю и Денису отдельно claim-ить read-only [PM-034-BE](tasks/PM-034-BE-backend-audit.md) и [PM-034-FE](tasks/PM-034-FE-frontend-audit.md), проверить гипотезы и передать отчёты Марку; рефакторинг кодом не запускать.
5. Готовить [PM-008](tasks/PM-008-pilot.md) как отдельный план измерения реальных добавлений, полезной выдачи и контакта без выдуманных базовых чисел.
