...
**Status:** planned / NEXT; сквозного опыта с GitHub-событием нет.
**Priority:** P2.
**Agent:** Игорь / Developer — предложен для узкой технической проверки после PM-043; claim и начало работы не подтверждены. **Owner:** Марк / Product Manager — решение по результату.
