...
| **NEXT — P1** | | | |
| [PM-044](PM-044-qa-mailboxes.md) | P1 | planned / NEXT — четыре inbox и привязка аккаунтов | Борис и Никита — по два ящика (claims нет); Денис — проверка и смена адресов после PM-040 (claim нет), Luna / Medium QA, Sol / Medium dev; Алексей — сервис/права при необходимости |
