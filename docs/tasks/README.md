...
| **NEXT — P1** | | | |
| [PM-044](PM-044-qa-mailboxes.md) | P1 | in progress — Gates 1–2 PASS; Gate 3 blocked до подтверждения фактических defaults по D019 | Борис / Sol 4/6 — acceptance `qa`/`lelik`; Никита / Sol 3/6 — регресс `qa2`/`qa3`; после подтверждения настроек новый Wake ID и claim |
