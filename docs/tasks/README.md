...
| **NEXT — P2** | | | |
| [PM-046](PM-046-github-event-existing-chat-wakeup.md) | P2 | in progress / NOW — GitHub push/PR event проверяется | Игорь / Developer claim 2026-09-26 05:12 UTC: один безопасный пилот только если поддержан, без нового агента; Sol / Medium |
