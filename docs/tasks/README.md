...
| Имя ожидается | Разработчик: календари / геолокация | Техническая реализация; актуальный scope через claim | Текущее назначение не выводится из старой истории |
...
| Имя ожидается | QA | Независимая проверка и отчёты | CHECK-H11 уже начат, требуется обновление статуса |
...
| [PM-004](PM-004-street-autofill.md) | Браузерный autofill перекрывает улицу; BUG-013 | P2 | planned | Не заявлен |
| [PM-005](PM-005-closed-dates-copy.md) | Понятная форма закрытых дат; BUG-014 | P2 | planned | Не заявлен |
