...
| [PM-002](PM-002-link-publication.md) | Внешняя ссылка + verification status + nudge | P1 | implementation in progress — D010 accepted, QA pending | Игорь / Developer |
...
| [PM-020](PM-020-host-cabinet-navigation.md) | Навигация действующих функций | P2 | planned — NEXT, после PM-019 | Не назначен |
