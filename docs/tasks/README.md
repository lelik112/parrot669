...
| [PM-036](PM-036-regression-qa-independent-two-accounts.md) | P1 | in progress — оба Worker развёрнуты; secret, ID allowlist и QA smoke открыты | Игорь / Developer; Никита / QA evidence; Sol / High (dev), Luna / Medium (QA) |
| **NEXT — P2** | | | |
