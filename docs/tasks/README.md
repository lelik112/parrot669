...
| **NOW — P2** | | | |
| [PM-048](PM-048-search-clarity-and-price-toggle.md) | P2 | in progress — Игорь подписал claim: три строки, короткий lead, крупный фильтр цены | Игорь / Sol 4/6; PR и browser smoke; Sol / Medium |
