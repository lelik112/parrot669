...
| **NOW — P2** | | | |
| [PM-046](PM-046-github-event-existing-chat-wakeup.md) | P2 | in progress — #60–#63 active; #64 Никита prepared/отложен, #65 Алекс prepared/не беспокоить | Марк / PM, Sol / Medium; #64 только после готовности Никиты, #65 только по явной просьбе Алекса; product dev claim нет |
