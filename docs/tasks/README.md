...
| **NOW — P2** | | | |
| [PM-046](PM-046-github-event-existing-chat-wakeup.md) | P2 | in progress — D017 rollout; #60 Марк/#61 Игорь/#62 Денис/#63 Борис active; #64 Никита/#65 Алекс prepared | Марк / PM координирует; Никита/Алекс — личная настройка, затем автоматический тест; Sol / Medium; без активного product dev claim |
