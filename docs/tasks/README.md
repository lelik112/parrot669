...
| **NOW — P2** | | | |
| [PM-046](PM-046-github-event-existing-chat-wakeup.md) | P2 | in progress — D017 rollout; #60 Марк/#61 Игорь/#62 Денис active; #63 Борис setup+test sent, receipt pending; #64 Никита/#65 Алекс prepared | Марк / PM координирует; Борис следующий по receipt, Никита/Алекс — личная настройка; Sol / Medium; без активного product dev claim |
