...
| **NOW — P2** | | | |
| [PM-048](PM-048-search-clarity-and-price-toggle.md) | P2 | planned — три строки, короткий lead и крупный фильтр цены | Игорю отправлен inbox #61; signed claim ещё нет; Sol / Medium |
