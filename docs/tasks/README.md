...
| **NEXT — P1** | | | |
| [PM-044](PM-044-qa-mailboxes.md) | P1 | in progress — Gates 1–2 PASS; D019 настройка подтверждена, Gate 3 ждёт re-claim и evidence | Борис / Sol 4/6 — acceptance `qa`/`lelik`; Никита / Sol 3/6 — регресс `qa2`/`qa3`; новые Wake ID отправляются |
