...
| **NEXT — P2** | | | |
| [PM-046](PM-046-github-event-existing-chat-wakeup.md) | P2 | planned — проверить GitHub push/PR event для существующего чата; сквозного теста нет | Игорь / Developer предложен, claim нет; Sol / Medium; Марк / PM принимает вывод |
