...
| [PM-024](PM-024-contact-from-every-search-result.md) | Контакт с хозяином из каждого результата | P1 | planned — NOW по D011; Игорю поручено, claim/model check ожидаются | Игорь / Developer (claim не подтверждён) |
| [PM-025](PM-025-search-contact-button-layout.md) | Расположение кнопки контакта в веб-выдаче | P1 | planned — NEXT после PM-024; web-дефект требует воспроизведения, mobile не проверен | Не назначен |
