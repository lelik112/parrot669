...
| [PM-002](PM-002-link-publication.md) | Внешняя ссылка + verification status + nudge | P1 | in review — Борис взял live QA после merge #19; production rollout требует подтверждения | Игорь / Developer; QA Борис |
