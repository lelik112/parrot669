...
- 2026-09-25 14:12 UTC — **Agent:** Борис. **Role:** QA. **Scope:** production parrot669.com desktop Chrome, qa guest, Barcelona 01–08.10.2026; no new message sent. **Change:** PARTIAL PASS for no-external-link variants: search returned three listings of lelik112 (The therd, One more, The second), each with «Переход на внешнюю площадку недоступен» and its own «Написать владельцу» link. Three distinct property IDs all preserved from/to dates. The second also had no price; clicking its CTA opened a new composer for The second and lelik112 with 01.10/08.10 prefilled. Together with the earlier verified/Airbnb listing, this confirms visible contact entry across observed link and price states. **Open:** whether a hidden saved link versus no saved link underlies these listings is unknown; send/delivery, previous opt-in, block/rate limits and mobile remain open. **Related task:** PM-024 / PM-025 / PM-003. **Next:** test remaining backend/recipient conditions with two controlled accounts after lelik restoration.

- 2026-09-25 ~14:35 UTC — **Борис / QA:** controlled main `qa` guest and QA Worker `lelik` owner, QA property with confirmed calendar and Airbnb link, Barcelona 2027-06-11→14. After owner unblocked the pair, guest sent follow-up from the existing conversation; owner received and replied; guest saw answer. A repeat «Написать владельцу» on the same search card returned to the exact existing conversation, preserving history rather than creating a duplicate. This verifies one two-account contact/return path. Other three no-external-link results previously showed CTA and correct draft but were not sent to their owners in this session. **Open:** rate limit, blocked guest via another property, first contact on each no-link variant, mobile. **Related task:** PM-024 / PM-003. **Owner:** Игорь / Developer; QA Борис.
