...
- 2026-09-25 ~14:43 UTC — **Борис / QA:** main origin `qa` session was observed unauthenticated in Messages (“Войдите снова, чтобы продолжить”) after successful two-account conversation, without a captured logout action in between. Worker `lelik` remained authenticated. No cause assigned; expiry time, expected TTL and server response were not captured. Login/auth acceptance still in review. **Related task:** PM-010 / PM-016.
