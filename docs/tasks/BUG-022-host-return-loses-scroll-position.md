...
**Status:** in progress — Игорь принял узкую диагностику и исправление; воспроизведение подтверждено QA на двух production origins. **Priority:** P2.
**Owner:** Игорь / Developer — claim 2026-09-26; QA: Борис. **Developer claim:** active, только восстановление scroll Host после Messages.
...
Игорь диагностирует BUG-022, делает узкое исправление и передаёт Борису проверяемый результат. Борис повторяет сценарий после выпуска; touch отдельно остаётся в PM-015.
