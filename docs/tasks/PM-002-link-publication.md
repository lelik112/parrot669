...
### 2026-09-25 14:14 UTC — Борис / QA — verified state in guest search

**Agent:** Борис. **Role:** QA. **Scope:** production parrot669.com desktop Chrome, qa as guest, Barcelona 11–14.06.2027; read-only. **Change:** PASS for observed verified state: lelik QA listing remained in search with a published Airbnb link and «Контроль календаря подтверждён ✓». EN/ES/CA/RU each displayed a corresponding confirmed-control label and the Airbnb link; the PARROT contact action remained present. No external page opened and no message sent. **Open:** no inference about ownership/identity; unverified/pending/failed/expired/legacy, invalid/mismatched URL, nudge, and publish-OFF BUG-017 retest remain unverified here. **Related task:** PM-002 / PM-024. **Next:** test remaining states with prepared source and owner controls; status stays in review.

### 2026-09-25 ~15:50 UTC — Борис / QA — publish OFF/ON independent retest

**Scope:** production desktop Cloud Chrome, QA Worker `lelik` owner and main `qa` guest, QA listing Barcelona 2027-06-11→14; no Airbnb page opened. **Baseline:** Host checkbox «Показывать внешнюю ссылку в поиске» checked; guest card showed Airbnb link, «Контроль календаря подтверждён ✓», and PARROT contact. **OFF:** owner unchecked and saw «Видимость внешней ссылки обновлена.»; after reopening Host checkbox remained unchecked. Guest reloaded search: same property still shown, external action replaced with «Переход на внешнюю площадку недоступен», «Написать владельцу» remained. **Restoration:** owner checked publish again; guest card regained Airbnb link and verified-control label, contact remained. Owner checkbox checked at end. No calendar/date/price state changed. **PASS:** reversible publication control and searchability/contact independent of link for this verified listing. **Open:** unverified/pending/failed/expired/legacy states, nudge draft and invalid/mismatched URL still need prepared data; this does not complete PM-002. **Owner:** Игорь / Developer; QA Борис.
