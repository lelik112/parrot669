...
**Status:** in progress / DNS pending — Zoho domain verification пройдена, четыре пользователя созданы 2026-09-26; MX/SPF/DKIM ещё не настроены и доступность inbox не подтверждена. Денис и Борис свои последующие этапы не claim-или. **Priority:** P1 / NEXT, разблокирует [PM-017](PM-017-qa-test-mailbox-access.md) и [PM-006](PM-006-email-acceptance.md).
