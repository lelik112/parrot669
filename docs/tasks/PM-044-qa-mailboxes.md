...
**Status:** in progress / provisioning blocked — Никита claim-ил этап 2026-09-26 04:24 UTC; Zoho Business account создан Алексеем, но domain verification и четыре пользователя не подтверждены, а cloud-browser Никиты не имеет авторизованной поддерживаемой Admin Console сессии. Денис и Борис свои последующие этапы не claim-или. **Priority:** P1 / NEXT, разблокирует [PM-017](PM-017-qa-test-mailbox-access.md) и [PM-006](PM-006-email-acceptance.md).
