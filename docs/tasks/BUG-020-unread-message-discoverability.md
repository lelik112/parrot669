...
**Status:** in progress — Денис расследует непостоянный глобальный badge после QA FAIL; ранее  desktop row/read and auto-refresh PASS, but repeat found missing global badge with unread row; iPhone Safari and languages remain open. **Priority:** P2.
