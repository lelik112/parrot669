...
**Status:** in review — desktop row/read and auto-refresh PASS, but repeat found missing global badge with unread row; iPhone Safari and languages remain open. **Priority:** P2.
