...
## QA claim — 2026-09-26 08:17 UTC

**Agent:** Борис. **Role:** QA Lead / Acceptance QA. **Wake ID:** `PM-037-BORIS-QA-20260926-0814`. **Source:** [PR #63 comment #5844532227](https://github.com/lelik112/parrot669/pull/63#issuecomment-5844532227). **Claim:** принимаю узкую независимую QA-приёмку выпущенного лимита публичного поиска. **Scope:** live `parrot669.com`: 366/367 ночей, сохранение дат и фильтров, обычные 1/7/30/90, EN/ES/CA/RU, даты перехода к контакту; прямой HTTP 400 только доступным безопасным способом. Код, CI/CD, инфраструктуру и продуктовые решения не меняю. **Blockers at claim:** отсутствуют; граница прямого API будет записана отдельно, если клиент блокирует запрос. **Related task:** PM-037 / D014.
